...
if __name__ == "__main__":
    ...
    dataset_path = 'D:/ALPR_Collections/Data/OCR/Plate_characters'
    ...
    train_loader = DataLoader(train_dataset, batch_size=8, shuffle=True, num_workers=6, collate_fn=collate_fn)
    ...
    test_path = 'D:/ALPR_Collections/Data/OCR/Plate_characters'
    test_dataset = LicensePlateDataset(root=test_path, split="test", transforms=get_transforms(False))
    ...
    torch.save(model, 'LP_OCR_model_60e.pth')
